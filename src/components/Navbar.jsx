      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 max-w-full">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="hidden md:flex space-x-10">
            {['Home', 'Products', 'About', 'Contact'].map((item, index) => (
              <motion.a
                ...
                whileHover={{ y: -2 }}
                className="text-gray-600 hover:text-primary-600 transition-colors text-sm font-medium relative"
              >
                {item}
                <motion.span
          ...
          <motion.button
            ...
            className="hidden md:block px-6 py-2.5 min-h-[44px] bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-md font-medium text-sm hover:from-primary-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg touch-manipulation"
          >
            Get Quote
          </motion.button>
